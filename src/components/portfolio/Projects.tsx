...
const projects = [
  ...
  },
  {
    ...
    desc: "CivicSync is an AI-powered smart governance platform that bridges the gap between citizens and municipal authorities through automated complaint management and transparent civic issue resolution.",
