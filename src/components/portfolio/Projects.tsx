...
const projects = [
  {
    ...
    desc: "Enterprise knowledge assistant for semantic document search. Multi-PDF RAG with OpenAI embeddings, source citations, RBAC, and an admin dashboard.",
  ...
  },
  {
    ...
    desc: "AI mock interview platform with role-specific questions, timed responses, and AI scoring. Includes resume analysis, Razorpay payments, and PDF reports.",
  ...
  },
  {
    ...
    desc: "Smart workforce dashboards with real-time tracking and geo-tagged activity. Integrates REST APIs, PostgreSQL services, and Scikit-learn task allocation.",
