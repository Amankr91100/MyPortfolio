...
// LeetCode icon (lucide doesn't ship one)
    ...
    <div className="flex items-center justify-center gap-3">
      {socials.map((s) => (
        <a
          ...
          aria-label={s.label}
          className={`glass ${dim} flex items-center justify-center rounded-full text-muted-foreground transition-smooth hover:-translate-y-0.5 hover:text-primary hover:shadow-glow`}
        >
