...
const items = [
  {
    ...
    org: "Deen Dayal Upadhyaya Gorakhpur University, Gorakhpur",
    desc: "Currently pursuing my undergraduate degree with a CGPA of 8.0/10. Coursework: Data Structures, Operating Systems, DBMS, Computer Networks, Machine Learning.",
    tag: "education",
